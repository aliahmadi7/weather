...
def get_weather():
    try:
        ...
        # weather
        api_key = "f58d6a48e90bf06538100423cc52ff93"
        ...
        condition_label.config(text=f"{condition} | FEELS LIKE TEMP {temp} °")
...
# search box
search_image = tk.PhotoImage(file="weather/search.png")
...
search_icon = tk.PhotoImage(file="weather/search_icon.png")
...
# logo
logo_image = tk.PhotoImage(file="weather/logo.png")
logo_label = tk.Label(root, image=logo_image)
logo_label.pack(side=tk.TOP)

# bottom box
frame_image = tk.PhotoImage(file="weather/box.png")
